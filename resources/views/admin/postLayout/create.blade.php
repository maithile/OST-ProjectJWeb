...
{!! Form::open(['action' => 'AdminPostLessonCotroller@store', 'method' => 'POST', 'enctype' => 'multipart/form-data' ]) !!}
 ...
 <div class="col-lg-12 col-sm-12">
    ...
    <div class="row with-forms">
        ...
        {{Form::textarea('script', '', ['id' =>'summary', 'class' => 'WYSIWYG', 'placeholder' => 'Text'])}}
        </div>
    </div>
        </div>
        </div>
        <div class="add-listing-section">
            ...
            <div class="add-listing-headline">
            <h3><i class="sl sl-icon-map"></i>Vocabulary</h3>
            </div>
                 
        <div class="row with-forms">
        <div class="col-md-4">
        {{Form::label('vocabulary', 'Vocabulary')}}
        {{Form::text('vocaburaly', '', ['class'=> 'form-control'])}}
        </div>

        <div class="col-md-8">
        {{Form::label('meaning', 'Meaning')}}
        {{Form::text('meaning', '', ['class'=> 'form-control'])}}
        </div>
        </div>
        </div>
